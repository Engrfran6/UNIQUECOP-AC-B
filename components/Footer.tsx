...
export default function Footer() {
  const footerLinks = {
    Shop: [
      ...
      {name: 'wax', href: '/products/wax'},
      {name: 'Books', href: '/products/books'},
      {name: 'Gift Sets', href: '/products/collections'},
    ],
    Support: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-warm-white/80 max-w-md">
              Handcrafted candles, premium wax, and curated books to create moments of tranquility
              in your everyday life.
            </p>
            <div className="flex space-x-4">
              <Link href="#" className="text-warm-white/60 hover:text-sage-green transition-colors">
        ...
        <div className="border-t border-warm-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col items-center md:flex-row space-y-2 md:space-y-0 md:space-x-6">
            ...
            <p className="text-warm-white/40 text-xs">
              Website created by
              <a
                href="https://deulosoftwares.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
                className="underline hover:text-sage-green font-bold">
                Deulo Software Solution (DSS)
              </a>
            </p>
          </div>
