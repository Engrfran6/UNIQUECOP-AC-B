  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "creamy-beige": "rgb(var(--creamy-beige) / <alpha-value>)",
        "soft-taupe": "rgb(var(--soft-taupe) / <alpha-value>)",
        "muted-gold": "rgb(var(--muted-gold) / <alpha-value>)",
        "dusty-rose": "rgb(var(--dusty-rose) / <alpha-value>)",
        "sage-green": "rgb(var(--sage-green) / <alpha-value>)",
        "charcoal-gray": "rgb(var(--charcoal-gray) / <alpha-value>)",
        "mocha-brown": "rgb(var(--mocha-brown) / <alpha-value>)",
      },
      borderRadius: {
        lg: "var(--radius)",
