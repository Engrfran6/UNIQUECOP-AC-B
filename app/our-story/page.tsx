            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <Image
                  ...
                  alt="Precious, Founder of Lumina"
                  width={400}
                  height={500}
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-charcoal-gray/80">
                  ...
                  <p>
                    "Today, Lumina represents everything I believe in: authentic craftsmanship,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-charcoal-gray/70 max-w-2xl mx-auto">
              From a kitchen experiment to a beloved brand, here's how Lumina has grown and evolved
              over the years.
            </p>
          </div>
      ...
      <section className="py-16 bg-sage-green/5">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-charcoal-gray/70 max-w-2xl mx-auto">
              Meet the passionate individuals who bring Lumina to life every day.
            </p>
          </div>
