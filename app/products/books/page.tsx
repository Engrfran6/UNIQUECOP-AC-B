...
const bookProducts = [
  {
    ...
    badge: "Featured",
    description:
      "A comprehensive guide to incorporating mindfulness into daily life",
    author: "Sarah Chen",
    pages: 240,
    genre: "Self-Help",
  },
  {
    ...
    badge: "Bestseller",
    description:
      "Discover the beauty of slowing down and savoring life's simple pleasures",
  ...
  },
  {
    ...
    category: "Books",
    description:
      "Complete guide to essential oils and their therapeutic benefits",
  ...
  },
  {
    ...
    category: "Books",
    description:
      "Learn the art of candle making from basic techniques to advanced designs",
    author: "James Wilson",
    pages: 350,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-charcoal-gray/80 mb-8">
              Thoughtfully selected books that inspire mindful living,
              creativity, and personal growth. Each title complements our
              philosophy of creating peaceful, intentional spaces.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            <aside className="lg:w-64">
              <ProductFilters category="books" />
            </aside>
            <main className="flex-1">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold text-charcoal-gray">
                  All Books ({bookProducts.length})
                </h2>
              </div>
              <Suspense fallback={<LoadingSpinner />}>
                <ProductGrid products={bookProducts} />
              </Suspense>
            </main>
          </div>
        </div>
