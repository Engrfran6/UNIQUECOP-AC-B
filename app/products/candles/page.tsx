...
const candleProducts = [
  {
    ...
    badge: "Best Seller",
    description:
      "A warm blend of vanilla and amber creates the perfect cozy atmosphere",
    scent: "Vanilla & Amber",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-charcoal-gray/80 mb-8">
              Each candle is lovingly hand-poured using premium soy wax and
              natural fragrances. Our artisanal process ensures a clean,
              long-lasting burn that fills your space with beautiful scents.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8">
            <aside className="lg:w-64">
              <ProductFilters category="candles" />
            </aside>
            <main className="flex-1">
              <div className="flex justify-between items-center mb-8">
                <h2 className="text-2xl font-bold text-charcoal-gray">
                  All Candles ({candleProducts.length})
                </h2>
              </div>
